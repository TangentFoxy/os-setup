-- Returns a table of detected graphics device types using the following names:
-- {
--   NVIDIA = true,
--   AMD = true,
--   integrated = true,
...
-- while this shouldn't change, since it is possible drivers or settings interfere with accuracy, I'm returning a function instead of the result
return function()
  local result = {}
